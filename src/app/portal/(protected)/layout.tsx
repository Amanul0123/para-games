...
export default async function PortalLayout({
  ...
  const user = session?.user as { role?: string; npc?: string } | undefined;
  ...
  return (
    <>
      ...
      <div className="relative flex min-h-screen" suppressHydrationWarning>
        ...
        <PortalSidebar npc={user?.npc} eventName={eventName} logoUrl={logoUrl} />

        <div className="relative min-h-screen flex-1 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-cyan-50">
          <div
